...
XInput is "finite" and won't change through time. So the following code should works in most of my future tools.
Why having a XInput code in a Scratch to Warcraft ?
Because:
- this project is the landing page of this workshop 😋
- I plan to allows a Warcraft version in split screen with fours Xinput gamepad.


Prefer those version if you can with your code:
- `1899887766` to manage the Gamepad Joysticks left and right on 4 bytes
- `1700000000` to manage all the buttons on 4 bytes

If you can't for any reasons, try the following one:
_🤖 Code generated from GPT without proper re-testing for now_
_Find the original code here: https://github.com/EloiStree/2024_11_21_ESP32HC05RC/blob/main/XESP32HC05RC/XESP32HC05RC.ino _

| **   Short Description**                     | **Integer to Press** | **Integer to Release** |
|-------------------------------------------|-----------------------|-------------------------|
| Random input for all gamepads, no menu    | 1399                 | 2399                   |
| Enable hardware joystick                  | 1390                 | 2390                   |
